...
<p align="center">
  Repositório dedicado aos estudos em JavaScript, com foco em:
  <strong> lógica de programação, manipulação do DOM, programação assíncrona,
  consumo de APIs, fundamentos do front-end e desenvolvimento moderno. 🚀</strong>
  <br><br>
...
├── .vscode<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/vscode/vscode-original.svg"
     width="15"
     style="vertical-align:middle;"/>/
│   └── settings.json<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/json/json-original.svg"
     width="18"
     style="vertical-align:middle;"/>
├── img/
...
<p align="center">
Este repositório tem como objetivo desenvolver fundamentos sólidos em <strong>JavaScript</strong>,
com foco em: programação web moderna, manipulação de eventos, controle assíncrono,
estruturas de dados, boas práticas de código e construção de aplicações interativas <br> 
🌐⚡.
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/🌐DOM-111827?style=for-the-badge&logo=code&logoColor=white" height="28"/>
  <img src="https://img.shields.io/badge/⚡Async/Await-FF8C00?style=for-the-badge&logo=code&logoColor=white" height="28"/>
  <img src="https://img.shields.io/badge/🤖APIs-0B5ED7?style=for-the-badge&logo=code&logoColor=white" height="28"/>
  <br>
